...
{
    class SelfCrossPromoUtils
    {
        public const string MORE_APPS_FILENAME = "Area730_SelfCrossPromo.json";
        ...
        {
            return Path.Combine(Application.persistentDataPath, "SelfCrossPromo_" + index + ".png");
        }
