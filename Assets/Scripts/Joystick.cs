...
public class Joystick : MonoBehaviour, IPointerUpHandler, IPointerDownHandler, IDragHandler, IEndDragHandler, IEventSystemHandler
{
	...
	//	{
	//		if (animationController.MainAnimator)
	//		{
	//			animationController.MainAnimator.SetBool("StopDance", false);
	//			animationController.MainAnimator.SetBool("StartDance", true);
	//		}
	//	}
	...
	//		if (animationController.MainAnimator)
	//		{
	//			CancelInvoke("StartDance");
	//			animationController.MainAnimator.SetBool("StartDance", false);
	//			animationController.MainAnimator.SetBool("StopDance", true);
	//		}
	//	}

	//}

	//public void StartDanceDelay(float delay)
	//{
	//	CancelInvoke("StartDance");
	//	Invoke("StartDance", delay);
	//}
