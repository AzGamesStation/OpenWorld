...
public class SpeedEffect : MonoBehaviour
{
	...
	private void Update()
	{
		if (curRbody.gameObject.activeInHierarchy && curRbody.linearVelocity.magnitude > velocityForEnableEffect)
		{
			float t = (Mathf.Clamp(curRbody.linearVelocity.magnitude, velocityForEnableEffect, velocityForMaxEffect) - velocityForEnableEffect) / (velocityForMaxEffect - velocityForEnableEffect);
