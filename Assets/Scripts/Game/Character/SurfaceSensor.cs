...
namespace Game.Character
{
	public class SurfaceSensor : WaterSensor
	{
		...
		{
			base.CheckSurface();
			UnityEngine.Debug.DrawRay(base.transform.position + TransformPositionOffset, -Vector3.up * CheckingRayLenght, Color.red);
			...
			currSurfaceStatePack.SetTypePack(aboveGround: false, aboveWater: false, currSurfaceStatePack.InWater);
