...
namespace Game.Character.Config
{
	public abstract class Config : MonoBehaviour
	{
		...
		public struct Vector3Param : Param
		{
			...
			public void Set(Param p)
			{
				Vector3Param vector3Param = (Vector3Param)(object)p;
				value = vector3Param.value;
			}
		...
		public struct Vector2Param : Param
		{
			...
			public void Set(Param p)
			{
				Vector2Param vector2Param = (Vector2Param)(object)p;
				value = vector2Param.value;
			}
		...
		public struct StringParam : Param
		{
			...
			public void Interpolate(Param p0, Param p1, float t)
			{
				StringParam stringParam = (StringParam)(object)p1;
				value = stringParam.value;
			}

			public void Set(Param p)
			{
				StringParam stringParam = (StringParam)(object)p;
				value = stringParam.value;
			}
		...
		public struct BoolParam : Param
		{
			...
			public void Interpolate(Param p0, Param p1, float t)
			{
				BoolParam boolParam = (BoolParam)(object)p1;
				value = boolParam.value;
			}

			public void Set(Param p)
			{
				BoolParam boolParam = (BoolParam)(object)p;
				value = boolParam.value;
			}
		...
		public struct SelectionParam : Param
		{
			...
			public void Interpolate(Param p0, Param p1, float t)
			{
				SelectionParam selectionParam = (SelectionParam)(object)p1;
				index = selectionParam.index;
			}

			public void Set(Param p)
			{
				SelectionParam selectionParam = (SelectionParam)(object)p;
				index = selectionParam.index;
			}
		...
		public string ResourceDir => Application.dataPath + "/Prefabs/Managers/GameCamera/Resources/Config/";
		...
		public void Update()
		{
			...
			Dictionary<string, Dictionary<string, Param>>.Enumerator enumerator = Params.GetEnumerator();
			if (enumerator.MoveNext())
			{
				Dictionary<string, Param>.Enumerator enumerator2 = enumerator.Current.Value.GetEnumerator();
		...
		private void CopyParams(Dictionary<string, Param> src, ref Dictionary<string, Param> dst)
		{
			...
			{
				if (dst.TryGetValue(item.Key, out Param value))
				{
		...
		{
			if (Params.TryGetValue(mode, out Dictionary<string, Param> value) && value.TryGetValue(key, out Param value2))
			{
		...
		{
			Vector3Param vector3Param = (Vector3Param)(object)currParams[key];
			return vector3Param.value;
		}
		...
		{
			Vector3Param vector3Param = (Vector3Param)(object)Params[currentMode][key];
			return vector3Param.value;
		}
		...
		{
			Vector2Param vector2Param = (Vector2Param)(object)currParams[key];
			return vector2Param.value;
		}
					...
					foreach (KeyValuePair<string, object> item in dictionary)
					{
						...
						if (dictionary2 != null)
						{
							foreach (KeyValuePair<string, object> item2 in dictionary2)
							{
								...
								{
									object[] array = item2.Value as object[];
									ConfigValue configValue = (ConfigValue)Enum.Parse(typeof(ConfigValue), array[0] as string);
									Param param = null;
									switch (configValue)
									{
									...
									{
										Params[item.Key] = new Dictionary<string, Param>();
									}
        ...
        {
            //Serialize( DefaultConfigPath);
            string path = (Application.dataPath + GetType().Name + ".txt");
