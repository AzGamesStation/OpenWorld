...
namespace Game.Character.Stats
{
	public class LevelManager : MonoBehaviour
	{
		...
		private void LevelUp()
		{
			...
			Data_Ironbolt.SendMissionComplete(level);
			...
			AnalyticsManager.instance.ProgressionEvent(AnalyticsManager.eventType.LevelComplete,GlobalConstant.openWorldMode, level);
