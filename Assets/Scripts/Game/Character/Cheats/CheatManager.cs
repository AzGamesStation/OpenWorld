...
namespace Game.Character.Cheats
{
	public class CheatManager : MonoBehaviour
	{
		...
		public void Teleport()
		{
			...
			if (Physics.Raycast(ray, out RaycastHit hitInfo, float.PositiveInfinity) && PlayerInteractionsManager.Instance != null)
			{
				PlayerInteractionsManager.Instance.TeleportPlayerToPosition(hitInfo.point);
			}
		}
	}
}
