...
namespace Game.Character.CharacterController
{
    public class HitEntity : MonoBehaviour
    {
      ...
      [SerializeField]
        ...
        {
            OnHit(DamageType.Instant, null, Health.Current * 2f, Vector3.zero, Vector3.zero);
        }

        public virtual void Die(HitEntity lastHitOwner)
        {
            OnHit(DamageType.Instant, lastHitOwner, Health.Current * 2f, Vector3.zero, Vector3.zero);
        }
        ...
        protected virtual void OnDie(DamageType damageType = DamageType.Energy)
        {
            if (!Dead)
            {
                Dead = true;
