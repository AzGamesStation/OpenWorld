...
namespace Game.Character.CharacterController
{
	public class PlayerManager : MonoBehaviour
	{
		...
		public void SwitchPlayer(GameObject newPlayerPrefab)
		{
			...
			currPlayerInstance = UnityEngine.Object.Instantiate(newPlayerPrefab, Player.transform.position, Player.transform.rotation);
		...
		public void ResetPlayer()
		{
			if (!IsOriginalPlayer)
			{
				...
				//defaultPlayerInstance.transform.position = playerPosition.position;
