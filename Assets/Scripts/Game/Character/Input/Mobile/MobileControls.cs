...
namespace Game.Character.Input.Mobile
{
	...
	public class MobileControls : MonoBehaviour
	{
		...
		{
			if (TryGetControl(key, out BaseControl ctrl))
			{
		...
		{
			if (TryGetControl(key, out BaseControl ctrl) && (ctrl.Type == ControlType.Stick || ctrl.Type == ControlType.CameraPanel))
			{
		...
		{
			if (TryGetControl(buttonName, out BaseControl ctrl))
			{
