...
namespace Game.Character.Input
{
	...
	public class ThirdPersonInput : GameInput
	{
		...
		public override void UpdateInput(Input[] inputs)
		{
			...
			SetInput(inputs, InputType.Laser, Controls.GetButton("Laser"));
			SetInput(inputs, InputType.Flame, Controls.GetButton("Flame"));
			SetInput(inputs, InputType.Webthrow, Controls.GetButton("Webthrow"));
			SetInput(inputs, InputType.Ballonthrow, Controls.GetButton("Ballonthrow"));
			SetInput(inputs, InputType.Bubblethrow, Controls.GetButton("Bubblethrow"));
		}
	}
}
