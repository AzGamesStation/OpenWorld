...
namespace Game.Character
{
    public class CameraManager : MonoBehaviour
    {
        ...
        public float TransitionSpeed => (!FastTranslation) ? NormalTransitionSpeed : FastTransitionSpeed;

        public float TransitionTimeMax => (!FastTranslation) ? NormalTransitionTimeMax : FastTransitionTimeMax;
        ...
        {
            if (cameraModes.TryGetValue(modeType, out CameraMode value))
            {
                return value;
            }
