...
namespace Game.Character.Modes
{
    ...
    public class DeadCameraMode : CameraMode
    {
        ...
        {
            Utils.Math.ToCartesian(rotX, rotY, out Vector3 dir);
        ...
        private void UpdateCollision()
        {
            ...
            collision.ProcessCollision(cameraTarget, GetTargetHeadPos(), UnityCamera.transform.forward, @float, out float _, out float collisionDistance);
