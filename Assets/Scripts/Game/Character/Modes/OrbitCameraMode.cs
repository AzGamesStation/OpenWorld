...
namespace Game.Character.Modes
{
	...
	public class OrbitCameraMode : CameraMode
	{
		...
		public void RotateCamera(Vector2 mousePosition)
		{
			...
			{
				Game.Character.Utils.Math.ToSpherical(UnityCamera.transform.forward, out float rotX, out float rotZ);
				...
				if (flag)
				{
					Game.Character.Utils.Math.ToCartesian(rotX, rotZ2, out Vector3 dir);
