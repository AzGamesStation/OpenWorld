...
namespace Game.Weapons
{
	public class RangeWeaponProjectile : RangedWeapon
	{
		...
		public override void Attack(HitEntity owner)
		{
			...
			{
				b = BaseRigidbody.linearVelocity;
			}
			...
			if (castResult.RayLength < 1f)
			{
				...
				if ((bool)component)
				{
					...
					{
						castResult.HitEntity.OnHit(component.HitDamageType, base.WeaponOwner, component.ProjectileDamage, vector, shotDirVector);
					}
