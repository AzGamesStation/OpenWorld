...
namespace Game.Weapons
{
	public class JointAmmoContainer : MonoBehaviour
	{
		...
		{
			ShopManager.Instance.SetBIValue(GameItemAmmo.ID, AmmoCount);
		}
		
		public void SaveAmmoDefault()
		{
			ShopManager.Instance.SetBIValue(GameItemAmmo.ID, 20);
		}
		...
		public void UpdateAmmo()
		{
			...
			AmmoCount = ShopManager.Instance.GetBIValue(GameItemAmmo.ID);
