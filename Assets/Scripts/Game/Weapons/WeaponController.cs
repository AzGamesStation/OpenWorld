...
namespace Game.Weapons
{
    public class WeaponController : MonoBehaviour
    {
        ...
        public void Initialization()
        {
            ...
            if (Owner is Player && AmmoText == null)
            {
        ...
        private void InitWeapon()
        {
            ...
            if ((bool)rangedWeapon && rangedWeapon.EnergyCost == 0f)
            {
                ...
                UpdateAmmoText(rangedWeapon);
            }
            else if ((bool)AmmoText)
            {
        ...
        public void UpdateAmmoText(RangedWeapon rangedWeapon)
        {
            ...
            if (Owner is Player && (bool)AmmoText)
            {
                AmmoText.text = rangedWeapon.AmmoCountText;
                if(rangedWeapon.AmmoCount<=0)
                {
                    UIGame.Instance.noBulletsPanel.SetActive(true);
                }
            }
        }
