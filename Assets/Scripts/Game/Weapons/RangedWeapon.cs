...
namespace Game.Weapons
{
    public class RangedWeapon : Weapon
    {
        ...
        protected override void Start()
        {
            ...
            if (Muzzle == null)
            {
                Debug.LogError("Can't find Muzzle");
            }
        ...
        private void Update()
        {
            ...
            {
                GameObject[] weaponObjects2 = WeaponObjects;
                foreach (GameObject gameObject2 in weaponObjects2)
                {
        ...
        public virtual RangedAttackState GetRangedAttackState()
        {
            ...
            if (base.WeaponOwner != null)
            {
                ...
                if (Physics.Raycast(ray, out RaycastHit hitInfo, AttackDistance, characterLayerMask))
                {
