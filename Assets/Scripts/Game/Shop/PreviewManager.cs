...
namespace Game.Shop
{
	public class PreviewManager : MonoBehaviour
	{
		...
		public static PreviewManager Instance => instance ?? (instance = UnityEngine.Object.FindObjectOfType<PreviewManager>());
		...
		{
			currentPreviewObject = UnityEngine.Object.Instantiate(item.PreviewVariables.PreviewModel, GetTransform(item.PreviewVariables.ItemPosition));
		...
		private void SetNewWeapon(GameItem item)
		{
			...
			currentPreviewObject = UnityEngine.Object.Instantiate(gameItemWeapon.PreviewVariables.PreviewModel, previewWeaponPlaceholder);
