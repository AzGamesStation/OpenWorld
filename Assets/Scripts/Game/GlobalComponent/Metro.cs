...
namespace Game.GlobalComponent
{
	public class Metro : MonoBehaviour
	{
		...
		public void ExitFromMetro()
		{
			...
			PlayerInteractionsManager.Instance.TeleportPlayerToPosition(EnterPoint);
		...
		private void OnTriggerEnter(Collider col)
		{
			...
			if ((bool)componentInParent && !componentInParent.IsFlying && !PlayerInteractionsManager.Instance.inVehicle)
			{
