...
namespace Game.GlobalComponent
{
    public class SectorManager : MonoBehaviour
    {
        ...
        public int GetSector(Vector3 pos)
        {
            ...
            {
                Debug.LogError("Out of sector net for Position: " + pos);
                return -1;
            }
        ...
        public int[] GetAroundSectors(int centerSector)
        {
            ...
            GetSectorCoords(centerSector, out int x, out int z);
            int num = 9;
        ...
        {
            GetSectorCoords(sector1, out int x, out int z);
            GetSectorCoords(sector2, out int x2, out int z2);
        ...
        private void SectorStatusUpdate()
        {
            ...
            if (sector != viewerSector)
            {
                ...
                if (IsExtraSectors())
                {
                    ...
                    GetSectorCoords(sector, out int x, out int z);
