...
namespace Game.GlobalComponent
{
	public class ObjectRespawner : MonoBehaviour
	{
		...
		protected void OnEnable()
		{
			...
			if (controlledObject == null && Time.time >= lostControllTime)
			{
				...
				if (ObjectType == RespawnedObjectType.Entity)
				{
					...
					if (component != null)
					{
						...
						component.ChangeController(SpawnGuardNpc ? BaseNPC.NPCControllerType.Smart : BaseNPC.NPCControllerType.Simple, out BaseControllerNPC controller);
