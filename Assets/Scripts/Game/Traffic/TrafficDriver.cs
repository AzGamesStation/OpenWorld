    ...
    public class TrafficDriver : MonoBehaviour
    {
        ...
        private IEnumerator CalculateSpeedForwardVehicles(float calculateTime)
        {
            ...
            while (calculateTime > 0f)
            {
                ...
                {
                    RootBody.linearVelocity = lastVehicle.MainRigidbody.linearVelocity;
                    calculated = true;
                    break;
                }
            ...
            if (!calculated)
            {
                RootBody.linearVelocity = cruiseVel * (target - startLine).normalized * (5f / 18f);
            }
        ...
        private void Update()
        {
            ...
            if (RootBody != null)
            {
                ...
                Vector3 vector2 = RootBody.transform.InverseTransformDirection(RootBody.linearVelocity);
                speed = vector2.z;
