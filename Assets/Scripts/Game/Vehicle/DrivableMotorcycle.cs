...
namespace Game.Vehicle
{
	public class DrivableMotorcycle : DrivableVehicle
	{
		...
		public override void StopVehicle()
		{
			...
			base.MainRigidbody.linearVelocity = Vector3.zero;
		}
		...
		public override bool IsDoorBlockedOffset(LayerMask blockedLayerMask, Transform driver, out Vector3 offset, bool horizontalCheckOnly = true)
		{
			...
			bool flag = false;
			bool flag2 = false;
			if (Physics.Raycast(vector, -base.transform.right, out RaycastHit hitInfo, ExitLeftMinDistance, blockedLayerMask))
			{
		...
		public override void SetDummyDriver(DummyDriver driver)
		{
			...
			if ((bool)DummyDriver)
			{
				DummyDriver.DriverStatus.DamageEvent += ((DrivableVehicle)this).OnDriverStatusDamageEvent;
		...
		public override void OnDriverStatusDamageEvent(float damage, HitEntity owner)
		{
			...
			{
				DummyDriver.DropRagdoll(owner, -(owner.transform.position - DummyDriver.transform.position).normalized * damage * 0.003f, !DummyDriver.DriverDead);
				ConstraintsSetup(isIn: false);
				base.MainRigidbody.ResetInertiaTensor();
			}
		}
		...
		public override void OnCollisionEnter(Collision col)
		{
			...
			if (num > 10f && (bool)DummyDriver)
			{
				DummyDriver.DropRagdoll(disturber, col.contacts[0].normal, !DummyDriver.DriverDead);
				ConstraintsSetup(isIn: false);
				base.MainRigidbody.ResetInertiaTensor();
			}
		}
