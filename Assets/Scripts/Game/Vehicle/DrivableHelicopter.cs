...
namespace Game.Vehicle
{
	public class DrivableHelicopter : DrivableVehicle
	{
		...
		protected override void FixedUpdate()
		{
			...
			{
				if(HelicopterControlPanel.Instance)
					HelicopterControlPanel.Instance.GetOutButton.SetActive(true);
			}
			else
			{
				if (HelicopterControlPanel.Instance)
					HelicopterControlPanel.Instance.GetOutButton.SetActive(false);
			}
		}
		...
		{
			base.MainRigidbody.linearDamping = bladesRotateSpeed / maxBladeRotateSpeed * RigidbodyMaxDrag;
		}
	}
}
