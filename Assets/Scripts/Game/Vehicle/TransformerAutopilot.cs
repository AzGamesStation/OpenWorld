...
namespace Game.Vehicle
{
	public class TransformerAutopilot : Autopilot
	{
		...
		public override void DropPassangers()
		{
			...
			component.DiedEvent = (HitEntity.AliveStateChagedEvent)Delegate.Combine(component.DiedEvent, new HitEntity.AliveStateChagedEvent(((Autopilot)this).DropedCopKillEvent));
		...
		{
			HitEntity component = transformer.GetComponent<HitEntity>();
			component.DiedEvent = (HitEntity.AliveStateChagedEvent)Delegate.Remove(component.DiedEvent, new HitEntity.AliveStateChagedEvent(((Autopilot)this).DropedCopKillEvent));
		}
	}
}
