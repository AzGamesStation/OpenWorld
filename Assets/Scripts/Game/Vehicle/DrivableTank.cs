...
namespace Game.Vehicle
{
	public class DrivableTank : DrivableVehicle
	{
		...
		{
			Autopilot componentInChildren = GetComponentInChildren<Autopilot>();
			bool flag = true;
			if (componentInChildren != null)
			{
				flag = (componentInChildren.DriverExit || componentInChildren.DriverWasKilled);
			}
			return base.IsAbleToEnter() && flag;
		}
		...
		protected override void OnCollisionSpecific(Collision col)
		{
			...
			if (component != null)
			{
				component.OnHit(DamageType.Collision, CurrentDriver, 100f, col.contacts[0].point, col.contacts[0].normal);
			}
		}
	}
}
