...
namespace Game.UI
{
    public class UIGame : MonoBehaviour
    {
        ...
        public ItemPickReward itemPickPanel;

        public ShowPickUpAd pickUpPanel;

        public GameObject itemParent;

        public GameObject dropRewardPanel;

        public BoosterPackage boosterPackage;

        public GameObject staminaPanel;

        public GameObject WeaponRewardPanel;

        public ButtonHandler flyBtn;
        ...
        public GameObject noBulletsPanel;
        ...
        public Text netTimerText, ballonTimerText, bubbleTimerText;
        ...
        private void Start()
        {
            //firebasecall1.Instance.Event("Gameplay_Start" + MApplication.CurrentLevel);
            AnalyticsManager.instance.ProgressionEvent(AnalyticsManager.eventType.LevelStart, GlobalConstant.openWorldMode, MApplication.CurrentLevel);
        }

        IEnumerator CheckForFlying()
        {
            yield return new WaitForSeconds(1f);
            if (wings.activeInHierarchy == false)
            {
                flyBtn.SetDownState("Fly");
            }
        }
        ...
        public void Complete(bool won, int starsCount)
        {
            ...
            if (won)
            {
                ...
                //firebasecall1.Instance.Event("Mission_Complete" + MApplication.CurrentLevel);
                AnalyticsManager.instance.ProgressionEvent(AnalyticsManager.eventType.LevelComplete, GlobalConstant.openWorldMode, MApplication.CurrentLevel);
            }
            else
            {
                ...
                //firebasecall1.Instance.Event("Mission_Fail" + MApplication.CurrentLevel);
        ...
        public void ShowRewardedAD()
        {
            ...
            {
                RewardedAdsController.Instance.ShowRewarded("FreeBullets");
                GlobalContants.getBullets = true;
            }
            else
            {
        ...
        {
            //AdsManager.instance.ShowInterstitial("Gameplay");
        }
    }
}
