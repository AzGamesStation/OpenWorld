	...
	public class AchievmentsViewController : MonoBehaviour
	{
		...
		private void OnEnable()
		{
			...
			if (GameEventManagerPrefab != null)
			{
				...
				{
					AchievementPanelItem achievementPanelItem = UnityEngine.Object.Instantiate(AchievPanelItem, achievHolder, worldPositionStays: false);
		...
		{
			Achievement.SaveLoadAchievmentStruct defaultValue = new Achievement.SaveLoadAchievmentStruct(complite: false, 0, 0);
